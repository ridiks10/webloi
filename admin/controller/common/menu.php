...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_customer_point'] = $this->language->get('text_customer_point');
		...
		$data['report_customer_package'] = $this->url->link('report/customer_package', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_customer_profit'] = $this->url->link('report/customer_profit', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['payment_bitcoin'] = $this->url->link('payment/bank_transfer', 'token=' . $this->session->data['token'], 'SSL');
