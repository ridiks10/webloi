...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_profit_6_month'] = $this->language->get('text_profit_6_month');
		$data['text_profit_12_month'] = $this->language->get('text_profit_12_month');
		...
		$data['entry_zalo'] = $this->language->get('entry_zalo');
		...
		// Dung add
		if (isset($this->error['zalo'])) {
			$data['error_zalo'] = $this->error['zalo'];
		} else {
			$data['error_zalo'] = '';
		}
	...
	if (isset($this->error['flickr'])) {
			$data['error_flickr'] = $this->error['flickr'];
		} else {
			$data['error_flickr'] = '';
		}
	if (isset($this->error['googleplus'])) {
			$data['error_googleplus'] = $this->error['googleplus'];
		} else {
			$data['error_googleplus'] = '';
		}
		
	if (isset($this->error['hoiphi'])) {
			$data['error_hoiphi'] = $this->error['hoiphi'];
		} else {
			$data['error_hoiphi'] = '';
		}
		
	if (isset($this->error['ngaydongphi'])) {
			$data['error_ngaydongphi'] = $this->error['ngaydongphi'];
		} else {
			$data['error_ngaydongphi'] = '';
		}
	if (isset($this->error['congtacphi'])) {
			$data['error_congtacphi'] = $this->error['congtacphi'];
		} else {
			$data['error_congtacphi'] = '';
		}
	if (isset($this->error['donghoiphitruoc1'])) {
			$data['error_donghoiphitruoc1'] = $this->error['donghoiphitruoc1'];
		} else {
			$data['error_donghoiphitruoc1'] = '';
		}
	if (isset($this->error['donghoiphitruoc2'])) {
			$data['error_donghoiphitruoc2'] = $this->error['donghoiphitruoc2'];
		} else {
			$data['error_donghoiphitruoc2'] = '';
		}
	if (isset($this->error['donghoiphitruoc3'])) {
			$data['error_donghoiphitruoc3'] = $this->error['donghoiphitruoc3'];
		} else {
			$data['error_donghoiphitruoc3'] = '';
		}
	if (isset($this->error['donghoiphitruoc4'])) {
			$data['error_donghoiphitruoc4'] = $this->error['donghoiphitruoc4'];
		} else {
			$data['error_donghoiphitruoc4'] = '';
		}
	if (isset($this->error['donghoiphitruoc5'])) {
			$data['error_donghoiphitruoc5'] = $this->error['donghoiphitruoc5'];
		} else {
			$data['error_donghoiphitruoc5'] = '';
		}
	if (isset($this->error['donghoiphitruoc6'])) {
			$data['error_donghoiphitruoc6'] = $this->error['donghoiphitruoc6'];
		} else {
			$data['error_donghoiphitruoc6'] = '';
		}
	if (isset($this->error['donghoiphitruoc7'])) {
			$data['error_donghoiphitruoc7'] = $this->error['donghoiphitruoc7'];
		} else {
			$data['error_donghoiphitruoc7'] = '';
		}
	if (isset($this->error['donghoiphitruoc8'])) {
			$data['error_donghoiphitruoc8'] = $this->error['donghoiphitruoc8'];
		} else {
			$data['error_donghoiphitruoc8'] = '';
		}
	if (isset($this->error['donghoiphitruoc10'])) {
			$data['error_donghoiphitruoc10'] = $this->error['donghoiphitruoc10'];
		} else {
			$data['error_donghoiphitruoc10'] = '';
		}
	
	if (isset($this->error['tangthang1'])) {
			$data['error_tangthang1'] = $this->error['tangthang1'];
		} else {
			$data['error_tangthang1'] = '';
		}
	if (isset($this->error['tangthang2'])) {
			$data['error_tangthang2'] = $this->error['tangthang2'];
		} else {
			$data['error_tangthang2'] = '';
		}
	if (isset($this->error['tangthang3'])) {
			$data['error_tangthang3'] = $this->error['tangthang3'];
		} else {
			$data['error_tangthang3'] = '';
		}
		...
		if (isset($this->request->post['config_date_pd'])) {
			$data['config_date_pd'] = $this->request->post['config_date_pd'];
		} else {
			$data['config_date_pd'] = $this->config->get('config_date_pd');
		}
		if (isset($this->request->post['config_date_gd'])) {
			$data['config_date_gd'] = $this->request->post['config_date_gd'];
		} else {
	...
	if (isset($this->request->post['config_flickr'])) {
			$data['config_flickr'] = $this->request->post['config_flickr'];
		} else {
			$data['config_flickr'] = $this->config->get('config_flickr');
		}
	if (isset($this->request->post['config_googleplus'])) {
			$data['config_googleplus'] = $this->request->post['config_googleplus'];
		} else {
			$data['config_googleplus'] = $this->config->get('config_googleplus');
		}
		
		if (isset($this->request->post['config_hoiphi'])) {
			$data['config_hoiphi'] = $this->request->post['config_hoiphi'];
		} else {
			$data['config_hoiphi'] = $this->config->get('config_hoiphi');
		}
		if (isset($this->request->post['config_ngaydongphi'])) {
			$data['config_ngaydongphi'] = $this->request->post['config_ngaydongphi'];
		} else {
			$data['config_ngaydongphi'] = $this->config->get('config_ngaydongphi');
		}
		if (isset($this->request->post['config_congtacphi'])) {
			$data['config_congtacphi'] = $this->request->post['config_congtacphi'];
		} else {
			$data['config_congtacphi'] = $this->config->get('config_congtacphi');
		}
		
		if (isset($this->request->post['config_donghoiphitruoc1'])) {
			$data['config_donghoiphitruoc1'] = $this->request->post['config_donghoiphitruoc1'];
		} else {
			$data['config_donghoiphitruoc1'] = $this->config->get('config_donghoiphitruoc1');
		}
		
		if (isset($this->request->post['config_donghoiphitruoc2'])) {
			$data['config_donghoiphitruoc2'] = $this->request->post['config_donghoiphitruoc2'];
		} else {
			$data['config_donghoiphitruoc2'] = $this->config->get('config_donghoiphitruoc2');
		}
		
		if (isset($this->request->post['config_donghoiphitruoc3'])) {
			$data['config_donghoiphitruoc3'] = $this->request->post['config_donghoiphitruoc3'];
		} else {
			$data['config_donghoiphitruoc3'] = $this->config->get('config_donghoiphitruoc3');
		}
		
		if (isset($this->request->post['config_donghoiphitruoc4'])) {
			$data['config_donghoiphitruoc4'] = $this->request->post['config_donghoiphitruoc4'];
		} else {
			$data['config_donghoiphitruoc4'] = $this->config->get('config_donghoiphitruoc4');
		}
		
		if (isset($this->request->post['config_donghoiphitruoc5'])) {
			$data['config_donghoiphitruoc5'] = $this->request->post['config_donghoiphitruoc5'];
		} else {
			$data['config_donghoiphitruoc5'] = $this->config->get('config_donghoiphitruoc5');
		}
		
		if (isset($this->request->post['config_donghoiphitruoc6'])) {
			$data['config_donghoiphitruoc6'] = $this->request->post['config_donghoiphitruoc6'];
		} else {
			$data['config_donghoiphitruoc6'] = $this->config->get('config_donghoiphitruoc6');
		}
		
		if (isset($this->request->post['config_donghoiphitruoc7'])) {
			$data['config_donghoiphitruoc7'] = $this->request->post['config_donghoiphitruoc7'];
		} else {
			$data['config_donghoiphitruoc7'] = $this->config->get('config_donghoiphitruoc7');
		}
		
		if (isset($this->request->post['config_donghoiphitruoc8'])) {
			$data['config_donghoiphitruoc8'] = $this->request->post['config_donghoiphitruoc8'];
		} else {
			$data['config_donghoiphitruoc8'] = $this->config->get('config_donghoiphitruoc8');
		}
		
		
		if (isset($this->request->post['config_donghoiphitruoc10'])) {
			$data['config_donghoiphitruoc10'] = $this->request->post['config_donghoiphitruoc10'];
		} else {
			$data['config_donghoiphitruoc10'] = $this->config->get('config_donghoiphitruoc10');
		}
		
		if (isset($this->request->post['config_tangthang1'])) {
			$data['config_tangthang1'] = $this->request->post['config_tangthang1'];
		} else {
			$data['config_tangthang1'] = $this->config->get('config_tangthang1');
		}
		if (isset($this->request->post['config_tangthang2'])) {
			$data['config_tangthang2'] = $this->request->post['config_tangthang2'];
		} else {
			$data['config_tangthang2'] = $this->config->get('config_tangthang2');
		}
		if (isset($this->request->post['config_tangthang3'])) {
			$data['config_tangthang3'] = $this->request->post['config_tangthang3'];
		} else {
			$data['config_tangthang3'] = $this->config->get('config_tangthang3');
		}
		//
	...
	protected function validate() {
		...
		if (!$this->request->post['config_hoiphi']) {
			$this->error['hoiphi'] = "Xin vui lòng nhập mức đóng hội phí";
		}

		if (!$this->request->post['config_ngaydongphi']) {
			$this->error['ngaydongphi'] = "Xin vui lòng nhập ngày cuối cùng phải đóng hội phí";
		}
		
		if (!$this->request->post['config_congtacphi']) {
			$this->error['congtacphi'] = "Xin vui lòng nhập mức công tác phí";
		}
		
		if (!$this->request->post['config_donghoiphitruoc1']) {
			$this->error['donghoiphitruoc1'] = "Xin vui lòng nhập mức đóng hội phí trước 1 tháng";
		}
		
		if (!$this->request->post['config_donghoiphitruoc2']) {
			$this->error['donghoiphitruoc2'] = "Xin vui lòng nhập mức đóng hội phí trước 2 tháng";
		}
		
		if (!$this->request->post['config_donghoiphitruoc3']) {
			$this->error['donghoiphitruoc3'] = "Xin vui lòng nhập mức đóng hội phí trước 3 tháng";
		}
		
		if (!$this->request->post['config_donghoiphitruoc4']) {
			$this->error['donghoiphitruoc4'] = "Xin vui lòng nhập mức đóng hội phí trước 4 tháng";
		}
		
		if (!$this->request->post['config_donghoiphitruoc5']) {
			$this->error['donghoiphitruoc5'] = "Xin vui lòng nhập mức đóng hội phí trước 5 tháng";
		}
		
		if (!$this->request->post['config_donghoiphitruoc6']) {
			$this->error['donghoiphitruoc6'] = "Xin vui lòng nhập mức đóng hội phí trước 6 tháng";
		}
		
		if (!$this->request->post['config_donghoiphitruoc7']) {
			$this->error['donghoiphitruoc7'] = "Xin vui lòng nhập mức đóng hội phí trước 7 tháng";
		}
		
		if (!$this->request->post['config_donghoiphitruoc8']) {
			$this->error['donghoiphitruoc8'] = "Xin vui lòng nhập mức đóng hội phí trước 8 tháng";
		}
		
		if (!$this->request->post['config_donghoiphitruoc10']) {
			$this->error['donghoiphitruoc10'] = "Xin vui lòng nhập mức đóng hội phí trước 10 tháng";
		}
		
		if (!$this->request->post['config_tangthang1']) {
			$this->error['tangthang1'] = "Xin vui lòng nhập số tầng tối đa được hưởng công tác phí trong tháng đầu tiên";
		}
		
		if (!$this->request->post['config_tangthang2']) {
			$this->error['tangthang2'] = "Xin vui lòng nhập số tầng tối đa được hưởng công tác phí trong tháng thứ 2";
		}
		
			if (!$this->request->post['config_tangthang3']) {
			$this->error['tangthang3'] = "Xin vui lòng nhập số tầng tối đa được hưởng công tác phí trong tháng thứ 3";
		}
