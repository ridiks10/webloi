<?php
// Heading
$_['heading_title']       = 'Pav Mô-đun sản phẩm - khối danh mục';

// Text
$_['text_module']         = 'Mô-đun';
$_['text_success']        = 'Thành công: Bạn đã thay đổi thành công mô-đun khối sản phẩm!';
...
$_['button_save_keep'] = "Lưu và Sửa";
$_['entry_icon_image'] = 'Biểu tượng - Hình ảnh';
$_['text_image_manager'] = 'Quản lý hình ảnh';

$_['text_browse']      = 'Duyệt';
$_['text_clear'] = 'Xoá';
$_['text_add_category'] = "Thêm danh mục";
$_['button_save_keep']  = "Lưu và Sửa";
$_['entry_category'] 	= 'Danh mục';
$_['entry_addition_class'] = 'Thêm Class';
// Entry
$_['entry_banner']        = 'Ảnh:';
$_['entry_dimension']     = 'Kích thước (W x H) và thay đổi kích thước:';
$_['entry_layout']        = 'Bố cục:';
$_['entry_position']      = 'Vị trí:';
$_['entry_status']        = 'Trạng thái:';
$_['entry_sort_order']    = 'Thứ tự:';
$_['entry_carousel']    = 'Số mục - Số cột - Giới hạn mục:';
$_[ 'entry_tabs' ] = 'Kiểu Tab sản phẩm';
...
$_['error_dimension']     = 'Yêu cầu nhập chiều cao, chiều rộng!';
$_['error_carousel']     = 'Nhập Độ rộng &amp;  Số mục - Số cột - Giới hạn số mục!';
