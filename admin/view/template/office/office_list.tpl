    ...
    <div id="content">
        <div class="page-header">
            <div class="container-fluid">
                ...
                <?php if(count($offices)<65){?>    <a href="<?php echo $insert; ?>" data-toggle="tooltip" title="<?php echo $button_insert; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a> <?php }?>
                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>Giám đốc văn phòng</td>	
                                        <td>Phó TGĐ Khu Vực</td>	
                                        <td>Phó TGĐ Miền</td>	
				                        <td>Tổng doanh số</td>
                                    ...
                                    <?php if ($offices) { ?>
			          			        <?php foreach($offices as $office) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $office['name_manager']; ?></td>
                                                <td><?php echo $office['name_vice_president1']; ?></td>
                                                <td><?php echo $office['name_vice_president2']; ?></td>
                                                <td>
                                                <?php $le_t = is_int($office['total_money']+0)? 0:3;
        	            							echo number_format($office['total_money'],$le_t,'.',',');
        	            						?>
                                                </td>
                                                <td class="text-right">
                                                    <a href="<?php echo $office['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } else { ?>
