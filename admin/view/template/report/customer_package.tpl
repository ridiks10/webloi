...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1>Report doanh số các gói đầu tư F1</h1>
      <ul class="breadcrumb">
  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i> Report doanh số gói đầu tư F1</h3>
      </div>
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr <?php if($activity['date_end'] != ''){echo 'class="row_disable"'; }?>>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/customer_package&token=<?php echo $token; ?>';
  ...
  $('#export').on('click', function() {
		...
		url = 'index.php?route=report/exportCommission&token=<?php echo $token; ?>';
