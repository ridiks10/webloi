        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <div class="tab-pane active" id="tab-config">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-meta-description">Date GD</label>
                <div class="col-sm-10">
              ...
              <fieldset>
                <legend>Percent Commission</legend>
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-meta-description">Percent Commission Package 1</label>
                <div class="col-sm-10">
          ...
          <div class="tab-content">
            <div class="tab-pane" id="tab-general">
              ...
              <?php // Dung add?>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-zalo"><?php echo $entry_zalo; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_zalo" value="<?php echo $config_zalo; ?>" placeholder="<?php echo $entry_zalo; ?>" id="input-zalo" class="form-control" />
                  <?php if ($error_zalo) { ?>
                  <div class="text-danger"><?php echo $error_zalo; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-flickr"><?php echo $entry_flickr; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_flickr" value="<?php echo $config_flickr; ?>" placeholder="<?php echo $entry_flickr; ?>" id="input-flickr" class="form-control" />
                  <?php if ($error_flickr) { ?>
                  <div class="text-danger"><?php echo $error_flickr; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_googleplus" value="<?php echo $config_googleplus; ?>" placeholder="<?php echo $entry_googleplus; ?>" id="input-googleplus" class="form-control" />
                  <?php if ($error_googleplus) { ?>
                  <div class="text-danger"><?php echo $error_googleplus; ?></div>
                  <?php } ?>
                </div>
              </div>
              <?php // End Dung add?>
            ...
            <fieldset>
                <legend>Phí hội viên</legend>
              <div class="form-group ">
                <label class="col-sm-4 control-label" for="input-hoiphi">Hội phí mỗi tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_hoiphi" value="<?php echo $config_hoiphi; ?>" placeholder="Hội phí mỗi tháng" id="input-hoiphi" class="form-control" />
                  <?php if ($error_hoiphi) { ?>
                  <div class="text-danger"><?php echo $error_hoiphi; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-ngaydongphi">Ngày cuối cùng nộp phí hội viên</label>
                <div class="col-sm-8">
                  <div >
                  <input type="text" name="config_ngaydongphi" value="<?php echo $config_ngaydongphi; ?>"   class="form-control" />
                  </div>
                  <?php if ($error_ngaydongphi) { ?>
                  <div class="text-danger"><?php echo $error_ngaydongphi; ?></div>
                  <?php } ?>
                </div>
              </div>
              </fieldset>
            <fieldset>
                <legend>công tác phí</legend>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-congtacphi">công tác phí</label>
                <div class="col-sm-8">
                  <input type="text" name="config_congtacphi" value="<?php echo $config_congtacphi; ?>" placeholder="công tác phí" id="input-congtacphi" class="form-control" />
                  <?php if ($error_congtacphi) { ?>
                  <div class="text-danger"><?php echo $error_congtacphi; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc1">Mức đóng hội phí trước 1 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc1" value="<?php echo $config_donghoiphitruoc1; ?>" placeholder="Mức đóng hội phí trước 1 tháng" id="input-donghoiphitruoc1" class="form-control" />
                  <?php if ($error_donghoiphitruoc1) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc1; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc2">Mức đóng hội phí trước 2 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc2" value="<?php echo $config_donghoiphitruoc2; ?>" placeholder="Mức đóng hội phí trước 2 tháng" id="input-donghoiphitruoc2" class="form-control" />
                  <?php if ($error_donghoiphitruoc2) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc2; ?></div>
                  <?php } ?>
                </div>
              </div>
<div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc3">Mức đóng hội phí trước 3 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc3" value="<?php echo $config_donghoiphitruoc3; ?>" placeholder="Mức đóng hội phí trước 3 tháng" id="input-donghoiphitruoc3" class="form-control" />
                  <?php if ($error_donghoiphitruoc3) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc3; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc4">Mức đóng hội phí trước 4 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc4" value="<?php echo $config_donghoiphitruoc4; ?>" placeholder="Mức đóng hội phí trước 4 tháng" id="input-donghoiphitruoc4" class="form-control" />
                  <?php if ($error_donghoiphitruoc4) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc4; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc5">Mức đóng hội phí trước 5 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc5" value="<?php echo $config_donghoiphitruoc5; ?>" placeholder="Mức đóng hội phí trước 5 tháng" id="input-donghoiphitruoc5" class="form-control" />
                  <?php if ($error_donghoiphitruoc5) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc5; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc6">Mức đóng hội phí trước 6 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc6" value="<?php echo $config_donghoiphitruoc6; ?>" placeholder="Mức đóng hội phí trước 6 tháng" id="input-donghoiphitruoc6" class="form-control" />
                  <?php if ($error_donghoiphitruoc6) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc6; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc7">Mức đóng hội phí trước 7 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc7" value="<?php echo $config_donghoiphitruoc7; ?>" placeholder="Mức đóng hội phí trước 7 tháng" id="input-donghoiphitruoc7" class="form-control" />
                  <?php if ($error_donghoiphitruoc7) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc7; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc8">Mức đóng hội phí trước 8 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc8" value="<?php echo $config_donghoiphitruoc8; ?>" placeholder="Mức đóng hội phí trước 8 tháng" id="input-donghoiphitruoc8" class="form-control" />
                  <?php if ($error_donghoiphitruoc8) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc8; ?></div>
                  <?php } ?>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-4 control-label" for="input-donghoiphitruoc10">Mức đóng hội phí trước 10 tháng</label>
                <div class="col-sm-8">
                  <input type="text" name="config_donghoiphitruoc10" value="<?php echo $config_donghoiphitruoc10; ?>" placeholder="Mức đóng hội phí trước 10 tháng" id="input-donghoiphitruoc10" class="form-control" />
                  <?php if ($error_donghoiphitruoc10) { ?>
                  <div class="text-danger"><?php echo $error_donghoiphitruoc10; ?></div>
                  <?php } ?>
                </div>
              </div>
              </fieldset>
            <fieldset>
                <legend>Số tầng nhận công tác phí</legend>
                <div class="form-group required">
	                <label class="col-sm-4 control-label" for="input-tangthang1">Số tầng tối đa được nhận công tác phí trong tháng đầu</label>
	                <div class="col-sm-8">
	                  <input type="text" name="config_tangthang1" value="<?php echo $config_tangthang1; ?>" placeholder="Số tầng tối đa được nhận công tác phí trong tháng đầu" id="input-tangthang1" class="form-control" />
	                  <?php if ($error_tangthang1) { ?>
	                  <div class="text-danger"><?php echo $error_tangthang1; ?></div>
	                  <?php } ?>
	                </div>
              	</div>
              	<div class="form-group required">
	                <label class="col-sm-4 control-label" for="input-tangthang2">Số tầng tối đa được nhận công tác phí trong tháng 2</label>
	                <div class="col-sm-8">
	                  <input type="text" name="config_tangthang2" value="<?php echo $config_tangthang2; ?>" placeholder="Số tầng tối đa được nhận công tác phí trong tháng 2" id="input-tangthang2" class="form-control" />
	                  <?php if ($error_tangthang2) { ?>
	                  <div class="text-danger"><?php echo $error_tangthang2; ?></div>
	                  <?php } ?>
	                </div>
              	</div>
              	<div class="form-group required">
	                <label class="col-sm-4 control-label" for="input-tangthang3">Số tầng tối đa được nhận công tác phí trong tháng 3</label>
	                <div class="col-sm-8">
	                  <input type="text" name="config_tangthang3" value="<?php echo $config_tangthang3; ?>" placeholder="Số tầng tối đa được nhận công tác phí trong tháng 3" id="input-tangthang3" class="form-control" />
	                  <?php if ($error_tangthang3) { ?>
	                  <div class="text-danger"><?php echo $error_tangthang3; ?></div>
	                  <?php } ?>
	                </div>
              	</div>
              </fieldset>
