<?php
class ControllerAccountCapcha extends Controller {
	public function index() {
		...
		$newImage = imagecreatefromjpeg("http://localhost/bitbanks/image/bg_captcha.jpg"); // Tạo hình ảnh từ bg_captcha.jpg
