...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['telephone_ct'])) {
			$data['error_telephone_ct'] = $this->error['telephone_ct'];
		} else {
			$data['error_telephone_ct'] = '';
		}
		...
		if (isset($this->request->post['telephone_ct'])) {
			$data['telephone_ct'] = $this->request->post['telephone_ct'];
		} else {
			$data['telephone_ct'] = $this->customer->getTelephone();
		}
