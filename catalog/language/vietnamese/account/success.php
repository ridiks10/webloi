...
// Text
$_['text_message']  = '<p>Xin chúc mừng! tài khoản của bạn đã được tạo thành công!</p> <p>Bạn có thể hưởng lợi ích từ việc thành thành viên khi đăng các banner quảng cáo trên website của chúng tôi.</p> <p>Nếu bạn có bất kì câu hỏi về hoạt động của website, vui lòng gửi email đến ban quản lý.</p> <p>Thư xác nhận đã gửi đến địa chỉ email mà bạn cung cấp. Nếu bạn không nhận được thư trong vòng 1 giờ tới, vui lòng <a href="%s">liên hệ chúng tôi</a>.</p>';
