         ...
         <div class="col-md-6 col-sm-6 col-xs-12 history-pin" style="margin-bottom:10px;">
            <div class="panel-provide">
               ...
               <div class="provide-info" style="background:none; min-height:155px">
                  ...
                  <img style="float: right;" src="https://chart.googleapis.com/chart?chs=150x150&amp;chld=L|1&amp;cht=qr&amp;chl=bitcoin:<?php echo $invoice['input_address'] ?>?amount=<?php echo (intval($invoice['amount']) / 100000000) ?>"/>
                  <?php } ?>
                  <p>Code: <code><?php echo $invoice['invoice_id_hash'] ?> <i class="fa fa fa-dropbox fa-1x"></i></code></p>
                  <p>Total: <code><?php echo (intval($invoice['amount']) / 100000000) ?> <i class="fa fa-btc" aria-hidden="true"></i></code></p>
                  <p>Received: <code><?php echo (intval($invoice['received']) / 100000000) ?> <i class="fa fa-btc" aria-hidden="true"></i></code></p>
