    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-telephone_ct"><?php echo $text_telephone; ?></label>
            <div class="col-sm-10">
              <input type="text" name="telephone_ct" value="<?php echo $telephone_ct; ?>" id="input-telephone_ct" class="form-control" />
              <?php if ($error_telephone_ct) { ?>
              <div class="text-danger"><?php echo $error_telephone_ct; ?></div>
              <?php } ?>
            </div>
          </div>
          <div class="form-group required">
